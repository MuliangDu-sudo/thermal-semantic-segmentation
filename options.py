...
def seg_parse():
    ...
    parser.add_argument('-checkpoint_name', type=str, default='freiburg_rgb2ir_segmentation.pth',
                        help='the name of trained model.')
    ...
    parser.add_argument('-translation_name', type=str, default='freiburg_rgb2ir_cityscapes', help='the folder name of translations.')
    ...
    parser.add_argument('-t2s_folder', type=str, default='test_freiburg_rgb2ir_2/')
    return parser
