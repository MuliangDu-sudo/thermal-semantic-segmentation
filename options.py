...
def translation_parse():
    ...
    parser.add_argument('-dataset', type=str, default='freiburg_ir', help='dataset to be translated.')
...
def seg_parse():
    ...
    parser.add_argument('-dataset', type=str, default='freiburg_rgb', help='select the dataset.')
